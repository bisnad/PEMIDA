...
transformer_load_weights_path = "results_Diane_Take2osc_30hz_transformer_audiovae_ld32_kld0.1/weights/transformer_weights_epoch_200"

# Eleni Version

transformer_load_weights_path = "results_Eleni_Take2osc_30hz_transformer_audiovae_ld32_kld0.1/weights/transformer_weights_epoch_200"

# Tim Version

transformer_load_weights_path = "results_Tim_Take2osc_30hz_transformer_audiovae_ld32_kld0.1/weights/transformer_weights_epoch_200"

"""

#transformer_load_weights_path = "results_Eleni_Take2fbx_30hz_transformer_audiovae_ld32_kld0.1/weights/transformer_weights_epoch_200"

transformer_load_weights_path = "results_Diane_Take2osc_30hz_transformer_audiovae_ld32_kld1.0_deconly/weights/transformer_weights_epoch_200"
...
for sI in range(len(mocap_all_data)):
    ...
    with torch.no_grad():
        ...
        for mfI in range(3, mocap_frame_count - mocap_input_output_seq_length - 40 - mocap_frame_incr, mocap_frame_incr):
...
test_mocap_start_times_sec = [5.0, 50.0, 100.0, 140.0, 160.0, 214.0, 270.0, 340.0]

# Eleni Version

test_mocap_start_times_sec = [20.0, 130.0, 240.0, 360.0, 480.0, 540.0, 660.0, 780.0]

# Tim Version

test_mocap_start_times_sec = [5.0, 25.0, 54.0, 90.0, 106.0, 226.0, 290.0, 320.0]

"""

test_mocap_start_times_sec = [5.0, 50.0, 100.0, 140.0, 160.0, 214.0, 270.0, 340.0]
test_mocap_duration_sec = 30.0
    
for test_mocap_start_time_sec in test_mocap_start_times_sec:
    
    test_mocap_start_time_frames = int(test_mocap_start_time_sec * mocap_fps)
    test_mocap_duration_frames = int(test_mocap_duration_sec * mocap_fps)
    
    if poseRenderer is not None:
        create_mocap_anim(test_mocap_data, test_mocap_start_time_frames, test_mocap_duration_frames, "results/anims/orig_mocap_{}-{}.gif".format(test_mocap_start_time_sec, (test_mocap_start_time_sec + test_mocap_duration_sec)))
    create_orig_audio(test_audio_data, test_mocap_start_time_frames, test_mocap_duration_frames, "results/audio/orig_audio_{}-{}.wav".format(test_mocap_start_time_sec, (test_mocap_start_time_sec + test_mocap_duration_sec)))
    create_vocos_audio(test_audio_data, test_mocap_start_time_frames, test_mocap_duration_frames, "results/audio/vocos_audio_{}-{}.wav".format(test_mocap_start_time_sec, (test_mocap_start_time_sec + test_mocap_duration_sec)))
    create_gen_audio(test_mocap_data, test_audio_data, test_mocap_start_time_frames, test_mocap_duration_frames, "results/audio/gen_audio_{}-{}_epoch_{}_orig.wav".format(test_mocap_start_time_sec, (test_mocap_start_time_sec + test_mocap_duration_sec), epochs))
...
test_mocap_valid_ranges = [[201, 11388],
                           ...
                           [306, 11494],
                           [582, 11769]]
test_mocap_start_times_sec = [[5.0, 50.0, 100.0, 140.0, 160.0, 214.0, 270.0, 355.0],
                          [5.0, 50.0, 100.0, 140.0, 160.0, 214.0, 270.0, 355.0],
                          [5.0, 50.0, 100.0, 140.0, 160.0, 214.0, 270.0, 355.0],
                          [5.0, 50.0, 100.0, 140.0, 160.0, 214.0, 270.0, 355.0],
                          [5.0, 50.0, 100.0, 140.0, 160.0, 214.0, 270.0, 355.0]]
...
test_mocap_valid_ranges = [[291, 24982],
                           [438, 25129]]
test_mocap_start_times_sec = [[20.0, 130.0, 240.0, 360.0, 480.0, 540.0, 660.0, 780.0],
...
test_mocap_data_path = "E:/Data/mocap/Diane/Solos/ZHdK_06.02.2026/xsens2osc_30hz/"
test_mocap_data_files = ["Diane_kld1.0_dectrain_evaluation.pkl"]
test_mocap_valid_ranges = [[0, 25437]]
test_mocap_start_times_sec = [[0.0]]
test_mocap_duration_sec = 780.0
...
for fI in range(len(test_mocap_data_files)):
    ...
    test_mocap_start_times2_sec = test_mocap_start_times_sec[fI]
    ...
    print("test_mocap_data s ", test_mocap_data["motion"]["pos_local"].shape)
    ...
    for test_mocap_start_time_sec in test_mocap_start_times2_sec:
        
        test_mocap_start_time_frames = int(test_mocap_start_time_sec * mocap_fps)
        test_mocap_duration_frames = int(test_mocap_duration_sec * mocap_fps)
        
        if poseRenderer is not None:
            create_mocap_anim(test_mocap_data, test_mocap_start_time_frames, test_mocap_duration_frames, "results/anims/test_mocap_{}_{}-{}.gif".format(test_mocap_data_file, test_mocap_start_time_sec, (test_mocap_start_time_sec + test_mocap_duration_sec)))
        create_gen_audio(test_mocap_data, test_audio_data, test_mocap_start_time_frames, test_mocap_duration_frames, "results/audio/test_gen_audio_{}_{}-{}_epoch_{}.wav".format(test_mocap_data_file, test_mocap_start_time_sec, (test_mocap_start_time_sec + test_mocap_duration_sec), epochs))
